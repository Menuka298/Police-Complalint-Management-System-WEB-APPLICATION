...
class AccidentComplaintList extends Component {
  constructor(props) {
    super(props);
    this.state = { business: [] };
  }
  componentDidMount() {
    ...
    axios
      .get("https://localhost:7257/api/AccidentCompalint")
      .then((response) => {
  ...
  btnUpdateClick = (e) => {
    ...
    if (answer) {
      ...
      axios
        .put("https://localhost:7257/api/AccidentCompalint/" + complaintid)
        .then((response) => {
          //this.setState({ business: response.data });
          console.log(response);
  ...
  btnUndoClick = (e) => {
    ...
    if (answer) {
      ...
      axios
        .put(
          "https://localhost:7257/api/AccidentCompalint/UndoAccidentComplaintStatus/" +
            complaintid
        )
        .then((response) => {
          //this.setState({ business: response.data });
    ...
    return (
      <div div className="wrapper">
        ...
        <div id="content">
          <Navigation />
          <div className="line">
            <h4 align="center">Accident Complaints List</h4>
                  ...
                  return (
                    <tr>
                      ...
                      <td>
                        <Link
                          to={{
                            pathname: "/ViewAccidentComplaint/" + item.id,
                            id: { id: item.id },
                          }}
...
export default AccidentComplaintList;
