...
export default function ViewNoneRegisterComplaint() {
  const { id } = useParams();
  console.log(id);
  ...
  useEffect(() => {
    ...
    axios
      .get("https://localhost:7257/api/NonRegisterComplaints/" + id)
      .then((response) => {
        ...
        <div className="line">
          ...
          <form className="row g-3">
            ...
            <div className="col-6">
              ...
              <input
                disabled
                value={new Date(business.complaintDate).toLocaleDateString(
                  "US"
                )}
                type="text"
                className="form-control"
